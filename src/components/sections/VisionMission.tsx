        ...
        >
          {blocks.map((b) => (
            <motion.div
              key={b.label}
              variants={fadeUp}
              className="group relative overflow-hidden rounded-2xl border border-graphite-100 bg-white p-8 shadow-soft transition-all duration-300 hover:shadow-card lg:p-10 dark:border-white/10 dark:bg-graphite-900"
            >
              <div
                aria-hidden
              ...
              <span className="mt-6 inline-block text-xs font-semibold uppercase tracking-[0.18em] text-brand">
                {b.label}
              </span>
